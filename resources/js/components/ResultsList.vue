                ...
                <div class="wrapper">
                    ...
                    <div v-if="state.prefs.showRating" class="img_rating">
                        <div class="img_rating_star" v-if="photo.img_rating>=1">
                            <img class="img_rating_star_filled" src="/svg/star-filled.svg" alt="1 star rating"></div>
                        <div class="img_rating_star" v-if="photo.img_rating>=2">
                            <img class="img_rating_star_filled" src="/svg/star-filled.svg" alt="2 star rating"></div>
                        <div class="img_rating_star" v-if="photo.img_rating>=3">
                            <img class="img_rating_star_filled" src="/svg/star-filled.svg" alt="3 star rating"></div>
                        <div class="img_rating_star" v-if="photo.img_rating>=4">
                            <img class="img_rating_star_filled" src="/svg/star-filled.svg" alt="4 star rating"></div>
                        <div class="img_rating_star" v-if="photo.img_rating>=5">
                            <img class="img_rating_star_filled" src="/svg/star-filled.svg" alt="5 star rating"></div>
                    </div>
